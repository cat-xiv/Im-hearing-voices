...
shared.mod_name = "Emote Changer FFA"
...
def group_data(race:Race, sex:Sex, voice:Voice, to_race:Race, to_emote:int) -> Options: 
    return {(emote_race, to_sex,to_voice):option_data(race,sex,voice, to_race,to_sex,to_voice, to_emote, emote_race) 
...
def option_data(race:Race, sex:Sex, voice:Voice, to_race:Race,to_sex:Sex,to_voice:Voice, to_emote:int, emote_race: Race) -> FileSwaps:
    return dict([swaps_data(race,sex,voice,to_race,to_sex,to_voice,to_emote, emote_race)])

def swaps_data(race:Race, sex:Sex, voice:Voice,to_race:Race,to_sex:Sex,to_voice:Voice,to_emote:int, emote_race: Race) -> Swap:
    return (from_file_id(race,sex,voice, to_race)+to_emote, to_file_id(emote_race,to_sex,to_voice)+to_emote)
...
if __name__ == "__main__":
    shared.make_mods(mods_data(), "./EmoteFFA")
